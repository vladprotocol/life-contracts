...
contract PancakeBunnies is ERC721, Ownable {
    ...
    constructor(string memory _baseURI) public ERC721("Vlad Life", "VL") {
...
contract BunnyMintingFarm is Ownable {
    ...
    constructor(
        ...
        bunnyIdURIs[0] = string(abi.encodePacked(_ipfsHash, "Common.json"));
        bunnyIdURIs[1] = string(abi.encodePacked(_ipfsHash, "Uncommon.json"));
        bunnyIdURIs[2] = string(abi.encodePacked(_ipfsHash, "Rare.json"));
        bunnyIdURIs[3] = string(abi.encodePacked(_ipfsHash, "Legendary.json"));
        // bunnyIdURIs[4] = string(abi.encodePacked(_ipfsHash, "Ghost.json"));

        // Set token names for each bunnyId
        pancakeBunnies.setBunnyName(0, "Common");
        pancakeBunnies.setBunnyName(1, "Uncommon");
        pancakeBunnies.setBunnyName(2, "Rare");
        pancakeBunnies.setBunnyName(3, "Legendary");
        // pancakeBunnies.setBunnyName(4, "Ghost");
    }
